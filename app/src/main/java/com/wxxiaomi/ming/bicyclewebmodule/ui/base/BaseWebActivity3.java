 ...
 */
public abstract class BaseWebActivity3 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(BaseWebActivity3.this);
    ...
    private void handlerDialogAction(DialogACtion dialogAction) {
        if(dialogAction instanceof LoadingAction){
            ...
            if(action.okCallback!=""){
                alertDialog = new AlertDialog.Builder(BaseWebActivity3.this)
...
//            Log.i("wang","+request.getUrl():"+request.getUrl().toString());
...
//        }
    ...
    private void handleForward(ForwardAction forwardAction) {
        ...
        if(forwardAction instanceof H5ACtion){
            ...
            Intent intent = new Intent(BaseWebActivity3.this,SimpleWebActivity3.class);
            if(action.data!=""){
...
//                startActivity(intent);
            ...
            Intent intent = new Intent(BaseWebActivity3.this, WebTabsActivity.class);
